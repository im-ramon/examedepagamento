            ...
            <form id="formulario" action="{{ route('app.fichaauxiliar') }}" method="post">
                ...
                <section id="form_informacoes_pessoais">
                    ...
                    <fieldset class="question_root">
                        ...
                        <section class="question_body">
                            <div class="question_title">
                                <p>Qual <strong>universo/ classificação</strong> do examinado?</p>
                            </div>
                            <div class="question_options">
                                <select name="universo" id="tipo_soldo">
                                    ...
                                    <option value="pens_mil">Pensionista Militar</option>
                                    <option value="pens_excmbt_2ten">Pensionista Ex-Combatente (2º Ten)</option>
                                    <option value="pens_excmbt_2sgt">Pensionista Ex-Combatente (2º Sgt)</option>
                                </select>
                            </div>
                        </section>
                    </fieldset>
                    ...
                    <fieldset class="question_root">
                        ...
                        <section class="question_body">
                            <div class="question_title">
                                <p>O examinado é <strong>isento de Imposto de Renda</strong>?
                                <p>
                            </div>
                            <div class="question_options">
                    ...
                    <section id="form_informacoes_financeiras_col1">
                        ...
                        <fieldset class="question_root">
                            ...
                            <section class="question_body">
                                ...
                                <div class="question_options">
                                    <input type="number" min="0" max="100" value="100.00" step="0.01"
                                        name="soldo_cota_porcentagem" id="soldo_cota_porcentagem"> %
                                </div>
                            </section>
                        </fieldset>
                        ...
                        <fieldset class="question_root">
                            ...
                            <section class="question_body">
                                <div class="question_title">
                                    <p>Qual porcentagem de <strong>soldo proporcional para cota</strong> o examinado
                                        recebe?
                                    </p>
                                </div>
                                <div class="question_options">
                                    <input type="number" min="0" max="100" value="100.00" step="0.01"
                                        name="soldo_prop_cota_porcentagem" id="soldo_prop_cota_porcentagem"> %
                                </div>
                            </section>
                        </fieldset>
                        ...
                        <fieldset class="question_root">
                            ...
                            <section class="question_body">
                                ...
                                <div class="question_options">
                                    <input type="radio" name="compl_ct_soldo" value="1"
                                        id="complementocotasoldosim"><label for="complementocotasoldosim">Sim</label>
                                    <input type="radio" name="compl_ct_soldo" value="0" id="complementocotasoldonao"
                                        checked><label for="complementocotasoldonao">Não</label>
                                </div>
                            </section>
                        </fieldset>
                        ...
                        <fieldset class="question_root">
                            ...
                            <section class="question_body">
                                <div class="question_title">
                                    <p>Qual o percentual que o examinado faz jus de <strong>Adicional de Tempo de
                                            Serviço</strong>?
                                    </p>
                                </div>
                                <div class="question_options">
                        ...
                        <fieldset class="question_root">
                            ...
                            <section class="question_body">
                                <div class="question_title">
                                    <p>O militar recebe <strong>Adicional de Compensação por Disponibilidade
                                            Militar</strong>?
                                    </p>
                                </div>
                                <div class="question_options">
                        ...
                        <fieldset class="question_root">
                            ...
                            <section class="question_body">
                                ...
                                <div class="question_options">
                                    <input type="radio" name="f_hvoo" value="1" id="hvoosim"><label
                                        for="hvoosim">Sim</label>
                                    <input type="radio" name="f_hvoo" value="0" id="hvoonao" checked><label
                                        for="hvoonao">Não</label>
                                </div>
                            </section>
                        ...
                        <fieldset class="question_root">
                            ...
                            <section class="question_body">
                                ...
                                <div class="question_options">
                                    <input type="radio" value="1" name="adic_pttc" id="pttcsim"><label
                                        for="pttcsim">Sim</label>
                                    <input type="radio" value="0" name="adic_pttc" id="pttcnao" checked><label
                                        for="pttcnao">Não</label>
                                </div>
                            </section>
                        </fieldset>
                        ...
                        <fieldset class="question_root">
                            ...
                            <section class="question_body">
                                ...
                                <div class="question_options">
                                    ...
                                    <input type="radio" value="0" name="adic_natalino" id="adicnatalinonao"
                                        checked><label for="adicnatalinonao">Não</label>
                                </div>
                            </section>
                            ...
                            <section class="question_body">
                                <div class="question_title">
                                    <p>O examinado já recebeu algum <strong>Adiantamento do Adicional Natino</strong>
                                        durante o
                                        ano?
                                        Se sim, qual valor?</p>
                                </div>
                                <div class="question_options">
                                    <input type="number" name="adic_natalino_valor_adiantamento" value="0" min="0"
                                        step="0.01" max="99999">
                                </div>
                            </section>
                        </fieldset>
                    ...
                    <section id="form_informacoes_financeiras_col2">
                        <fieldset class="question_root">
                            ...
                            <section class="question_body">
                                ...
                                <div class="question_options">
                                    <input type="radio" value="1" name="aux_invalidez" id="auxinvsim"><label
                                        for="auxinvsim">Sim</label>
                        ...
                        <fieldset class="question_root">
                            ...
                            <section class="question_body">
                                ...
                                <div class="question_options">
                                    <div class="question_options">
                                        <input type="radio" value="1" name="f_aux_transporte"
                                            id="f_aux_transportesim"><label for="f_aux_transportesim">Sim</label>
                                        <input type="radio" value="0" name="f_aux_transporte" id="f_aux_transportenao"
                                            checked><label for="f_aux_transportenao">Não</label>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section class="question_body">
                                ...
                                <div class="question_options">
                                    <input type="number" name="aux_transporte" min="0" value="0" step="0.01"
                                        max="10000">
                                </div>
                            </section>
                        </fieldset>
                        ...
                        <fieldset class="question_root">
                            ...
                            <section class="question_body">
                                ...
                                <div class="question_options">
                                    <input type="radio" value="1" name="aux_fard" id="auxfardsim"><label
                                        for="auxfardsim">Sim</label>
                            ...
                            <section class="question_body">
                                ...
                                <div class="question_options">
                                    <input type="radio" value="1" name="aux_fard_primeiro"
                                        id="auxfardprimeirosim"><label for="auxfardprimeiro">Sim</label>
                                    <input type="radio" value="0" name="aux_fard_primeiro" id="auxfardprimeironao"
                                        checked><label for="auxfardprimeiro">Não</label>
                                </div>
                            </section>
                        </fieldset>
                        ...
                        <fieldset class="question_root">
                            ...
                            <section class="question_body">
                                ...
                                <div class="question_options">
                                    ...
                                    <input type="radio" value="0" name="f_aux_natalidade" id="auxnatalidadenao"
                                        checked><label for="auxnatalidadenao">Não</label>
                                </div>
                            </section>
                        ...
                        <fieldset class="question_root">
                            ...
                            <section class="question_body">
                                <div class="question_title">
                                    <p>Qual tipo de <strong>Gratificação de Localidade Especial</strong> o examinado
                                        recebe?
                                    </p>
                                </div>
                                <div class="question_options">
                                    <input type="radio" value="0" id="grat_loc_esp_nao" name="grat_loc_esp" checked
                                        min="0" value="0" step="0.01" max="99999"><label for="grat_loc_esp_nao">Não
                                        recebe</label>
                                    <input type="radio" value="A" id="grat_loc_esp_A" name="grat_loc_esp" min="0"
                                        value="A" step="0.01" max="99999"><label for="grat_loc_esp_A">Tipo "A"</label>
                                    <input type="radio" value="B" id="grat_loc_esp_B" name="grat_loc_esp" min="0"
                                        value="B" step="0.01" max="99999"><label for="grat_loc_esp_B">Tipo "B"</label>
                                </div>
                            </section>
                        </fieldset>
                        ...
                        <fieldset class="question_root">
                            ...
                            <section class="question_body">
                                ...
                                <div class="question_options">
                                    ...
                                    <input type="radio" value="0" name="grat_repr_cmdo" id="gratrepcmdonao"
                                        checked><label for="gratrepcmdonao">Não</label>
                                </div>
                            </section>
                        </fieldset>
                        ...
                        <fieldset class="question_root">
                            ...
                            <section class="question_body">
                                ...
                                <div class="question_options">
                                    ...
                                    <input type="radio" value="0" name="f_dp_excmb_art_9" id="dp_excmb_art_9_nao"
                                        checked><label for="dp_excmb_art_9_nao">Não</label>
                                </div>
                            </section>
                            ...
                            <section class="question_body">
                                ...
                                <div class="question_options">
                                    <input type="number" name="dp_excmb_art_9" max="99999" min="0" value="0"
                                        step="0.01">
                                </div>
                            </section>
                        </fieldset>
                        ...
                        <fieldset class="question_root">
                            ...
                            <section class="question_body">
                                ...
                                <div class="question_options">
                                    <div class="question_options">
                                        <input type="radio" value="1" name="pmil" id="pmilsim" checked><label
                                            for="pmilsim">Sim</label>
                                        <input type="radio" value="0" name="pmil" id="pmilnao"><label
                                            for="pmilnao">Não</label>
                                    </div>
                                </div>
                            </section>
                            <section class="question_body">
                        ...
                        <fieldset class="question_root">
                            ...
                            <section class="question_body">
                                ...
                                <div class="question_options">
                                    <div class="question_options">
                                        <input type="radio" value="1" name="pmil_15" id="pmil15sim"><label
                                            for="pmil15sim">Sim</label>
                        ...
                        <fieldset class="question_root">
                            ...
                            <section class="question_body">
                                <div class="question_title">
                                    <p>A pensionista contribui com o desconto <strong>extraordinário de Pensão Militar
                                            de
                                            3.0%</strong>?
                                    </p>
                                </div>
                                <div class="question_options">
                                    <div class="question_options">
                                        <input type="radio" value="1" name="pmil_30" id="pmil30sim"><label
                                            for="pmil30sim">Sim</label>
                            ...
                            <section class="question_body">
                                ...
                                <div class="question_options">
                                    <div class="question_options">
                                        ...
                                        <input type="radio" value="0" name="fusex_3" id="fusexnao"><label
                                            for="fusexnao">Não</label>
                                    </div>
                                </div>
                            </section>
                        </fieldset>
                        ...
                        <fieldset class="question_root">
                            ...
                            <section class="question_body">
                                ...
                                <div class="question_options">
                                    <div class="question_options">
                                        <input type="radio" value="0" name="desc_dep_fusex" id="desc_dep_fusex_nao"
                                            checked>
                        ...
                        <fieldset class="question_root">
                            ...
                            <section class="question_body">
                                ...
                                <div class="question_options">
                                    <div class="question_options">
                                        <input type="number" name="pens_judiciaria_1" min="0" value="0" step="0.01"
                                            max="99999" required>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section class="question_body">
                                ...
                                <div class="question_options">
                                    <div class="question_options">
                                        <input type="number" name="pens_judiciaria_2" min="0" value="0" step="0.01"
                                            max="99999" required>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section class="question_body">
                                ...
                                <div class="question_options">
                                    <div class="question_options">
                                        <input type="number" name="pens_judiciaria_3" min="0" value="0" step="0.01"
                                            max="99999" required>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section class="question_body">
                                ...
                                <div class="question_options">
                                    <div class="question_options">
                                        <input type="number" name="pens_judiciaria_4" min="0" value="0" step="0.01"
                                            max="99999" required>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section class="question_body">
                                ...
                                <div class="question_options">
                                    <div class="question_options">
                                        <input type="number" name="pens_judiciaria_5" min="0" value="0" step="0.01"
                                            max="99999" required>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section class="question_body">
                                ...
                                <div class="question_options">
                                    <div class="question_options">
                                        <input type="number" name="pens_judiciaria_6" min="0" value="0" step="0.01"
                                            max="99999" required>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section class="question_body">
                                ...
                                <div class="question_options">
                                    <div class="question_options">
                                        <input type="number" name="pens_judiciaria_adic_natal_1" min="0" value="0"
                            ...
                            <section class="question_body">
                                ...
                                <div class="question_options">
                                    <div class="question_options">
                                        <input type="number" name="pens_judiciaria_adic_natal_2" min="0" value="0"
                                            step="0.01" max="99999" required>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section class="question_body">
                                ...
                                <div class="question_options">
                                    <div class="question_options">
                                        <input type="number" name="pens_judiciaria_adic_natal_3" min="0" value="0"
                                            step="0.01" max="99999" required>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section class="question_body">
                                ...
                                <div class="question_options">
                                    <div class="question_options">
                                        <input type="number" name="pens_judiciaria_adic_natal_4" min="0" value="0"
                                            step="0.01" max="99999" required>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section class="question_body">
                                ...
                                <div class="question_options">
                                    <div class="question_options">
                                        <input type="number" name="pens_judiciaria_adic_natal_5" min="0" value="0"
                                            step="0.01" max="99999" required>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section class="question_body">
                                ...
                                <div class="question_options">
                                    <div class="question_options">
                                        <input type="number" name="pens_judiciaria_adic_natal_6" min="0" value="0"
                                            step="0.01" max="99999" required>
                                    </div>
                                </div>
                            </section>
