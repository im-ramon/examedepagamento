            ...
            <form id="formulario" action="{{ route('app.fichaauxiliar') }}" method="post">
                ...
                <section id="form_informacoes_financeiras">
                    ...
                    <fieldset class="question_root">
                        ...
                        <section class="question_body">
                            <div class="question_title">
                                <p>Qual porcentagem de <strong>soldo proporcional para cota</strong> o examinado recebe?
                                </p>
                            </div>
                            <div class="question_options">
                                <input type="number" min="0" max="100" value="100.00" step="0.01"
                    ...
                    <fieldset class="question_root">
                        ...
                        <section class="question_body">
                            ...
                            <div class="question_options">
                                <input type="radio" value="0" id="grat_loc_esp_nao" name="grat_loc_esp" checked min="0"
                                    value="0" step="0.01" max="99999"><label for="grat_loc_esp_nao">Não recebe</label>
                                <input type="radio" value="A" id="grat_loc_esp_A" name="grat_loc_esp" min="0" value="A"
                                    step="0.01" max="99999"><label for="grat_loc_esp_A">Tipo "A"</label>
                                <input type="radio" value="B" id="grat_loc_esp_B" name="grat_loc_esp" min="0" value="B"
                                    step="0.01" max="99999"><label for="grat_loc_esp_B">Tipo "B"</label>
                            </div>
                        </section>
                    </fieldset>
                    ...
                    <fieldset class="question_root">
                        ...
                        <section class="question_body">
                            <div class="question_title">
                                <p>A pensionista contribui com o desconto <strong>extraordinário de Pensão Militar de
                                        3.0%</strong>?
                                </p>
                            </div>
                            <div class="question_options">
