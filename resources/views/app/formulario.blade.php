...
<head>
    ...
    <title>Formulário - Exame de pagamento</title>
        ...
        <form id="formulario" action="{{ route('app.fichaauxiliar') }}" method="post">
            ...
            <section id="form_informacoes_financeiras">
                ...
                <fieldset class="question_root">
                    ...
                    <section class="question_body">
                        <div class="question_title">
                            <p>O militar recebe <strong>Adicional de Compensação por Disponibilidade Militar</strong>?
                            </p>
                        </div>
                        <div class="question_options">
                ...
                <fieldset class="question_root">
                    ...
                    <section class="question_body">
                        ...
                        <div class="question_title">
                            <p>Qual o percentual que o examinado recebe de <strong>Adicional de Permanência</strong>?
                            </p>
                        </div>
                        <div class="question_options">
                ...
                <fieldset class="question_root">
                    ...
                    <section class="question_body">
                        <div class="question_title">
                            <p>O examinado já recebeu algum <strong>Adiantamento do Adicional Natino</strong> durante o
                                ano?
                                Se sim, qual valor?</p>
                        </div>
                        <div class="question_options">
